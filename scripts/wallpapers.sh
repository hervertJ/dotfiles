...
done | rofi -dmenu -i -p "Seleccionar Wallpaper:" -show-icons -config ~/.config/rofi/config.rasi)
...
swww img "$DIR/$SELECTED" --transition-type center --transition-fps 60 --transition-step 255
wal -i "$DIR/$SELECTED"
